$(document).ready(function(){
	...
	// Other checkbox handler uncheck select all if selection changes
	//
	//
	$(".databox input:checkbox").click(function(){
	...
	function outputTaskArray()
	{
		...
		for(var i = 0; i < taskArray.length; i++)
		{
			$("#task_data").prepend("<div class='row'>"
				+ "<div class='cell checkbox databox' id='" + i + "'>"
